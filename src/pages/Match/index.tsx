...
import ModalAddMatch from '@/components/ModalAddMatch'
...
const Match = () => {
	...
	return (
		<>
			...
			>
				Bạn chắc chắn muốn Xóa trận đấu này chứ?
			</Modal>
			<div className="wrapper">
				<div className="wrapper-box">
					<div className="content">
						<div className="intro-y flex items-center mt-8">
							<h2 className="text-lg font-medium mr-auto">Danh sách trận đấu</h2>
						</div>
												...
												<table className="table">
													<thead className="table-dark">
														<tr className="text-center">
															...
															<th className="whitespace-nowrap">Tên đội đấu 1</th>
															<th className="whitespace-nowrap">Số bàn thắng ghi đội đấu 1</th>
                              <th className="whitespace-nowrap">Tên đội đấu 2</th>
															<th className="whitespace-nowrap">Số bàn thắng ghi đội đấu 2</th>
